...
public class JwtService {
    ...
    public String generateToken(String userName,String userId) {
        ...
        claims.put("userId",userId);// Adding custom claim
        ...
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 60 * 3)).signWith(getKey(),SignatureAlgorithm.HS256).compact();
    }
